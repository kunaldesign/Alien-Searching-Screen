...
var leftLensTimeline = new TimelineMax({
  repeat: -1,
...
var leftArmPortion = new TimelineMax({
  repeat: -1,
  repeatDelay: _repeatDelay,
}).timeScale(3);
...
var rightArmPortion = new TimelineMax({
  repeat: -1,
  repeatDelay: _repeatDelay,
}).timeScale(3);
...
var rightLensTimeline = new TimelineMax({
  repeat: -1,
  repeatDelay: _repeatDelay,
}).timeScale(3);
...
var leftLensLower = new TimelineMax({
  repeat: -1,
  repeatDelay: _repeatDelay,
}).timeScale(3);
...
var rightLensLower = new TimelineMax({
  repeat: -1,
  repeatDelay: _repeatDelay,
}).timeScale(3);
...
var headGroup = new TimelineMax({
  repeat: -1,
  repeatDelay: _repeatDelay * 2,
}).timeScale(6);
...
var fin = new TimelineMax({ repeat: -1, repeatDelay: _repeatDelay }).timeScale(
  3
);
...
leftLeg
  .to(target, 3, {
    attr: { points: "210.67,413.11 205.67,392.78 210.67,366.56" },
  })
  .to(target, 3, {
    attr: { points: "210.67,413.11 210.67,392.78 210.67,366.56" },
  })
  .to(target, 3, {
    attr: { points: "210.67,413.11 205.67,392.78 210.67,366.56" },
  })
...
rightLeg
  .to(target, 3, {
    attr: { points: "254.75,413.11 259.75,392.78 254.75,366.56" },
  })
  .to(target, 3, {
    attr: { points: "254.75,413.11 254.75,392.78 254.75,366.56" },
  })
  .to(target, 3, {
    attr: { points: "254.75,413.11 259.75,392.78 254.75,366.56" },
  })
...
var leftFoot = new TimelineMax({
  repeat: -1,
  repeatDelay: _repeatDelay * 20,
}).timeScale(24);
